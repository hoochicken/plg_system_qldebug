...
<div class="qldebugInner qldebug<?php echo ucwords($type);?>">
    <?php if(2!=$params->get('output',1)):?>
        <div id="qldebugButton" class="qldebugInner">
            <button id="qldebugHide" class="btn" onclick="document.getElementById('qldebugShow').style.display='block';document.getElementById('qldebugHide').style.display='none';document.getElementById('qldebugInnerContainer').style.display='none';"><?php echo JText::_('PLG_SYSTEM_QLDEBUG2');?> <?php echo JText::_('JHIDE');?></button>
            <button id="qldebugShow" class="btn" style="display:none;" onclick="document.getElementById('qldebugShow').style.display='none';document.getElementById('qldebugHide').style.display='block';document.getElementById('qldebugInnerContainer').style.display='block';"><?php echo JText::_('PLG_SYSTEM_QLDEBUG2');?> <?php echo JText::_('JSHOW');?></button>
        </div>
    <?php endif;?>
